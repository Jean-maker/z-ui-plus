...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: "基础组件", link: "/components/ZInput/base.md" },
      {
        text: "GitHub地址",
    ...
    sidebar: {
      "/components": [
        ...
        },
        {
          text: "我的组件-表单",
          items: [
            { text: "layout组件", link: "/components/ZLayout/base.md" },
            { text: "日期组件", link: "/components/ZDate/base.md" },
            { text: "z-radio单选框", link: "/components/ZRadio/base.md" },
            { text: "z-checkbox多选框", link: "/components/ZCheckbox/base.md" },
            { text: "z-select选择组件", link: "/components/ZSelect/base.md" },
            { text: "z-tree-select选择组件", link: "/components/ZTreeSelect/base.md" }
          ]
        }
      ]
    }
